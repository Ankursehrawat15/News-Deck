...
public class EntertainmentFragment extends Fragment {
   ...
   private final String API_KEY = "Your Api Key Here";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.entertain_recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        retriveJson("in" , API_KEY , "entertainment");

        return view;
    }

    public void retriveJson(String country , String apiKey , String category) {
